function script_fast_rcnn_PL_Pizza_VGG16()
...
% cache name
opts.cache_name             = 'fast_rcnn_PL_Pizza_VGG16';
% config
conf                        = fast_rcnn_config('image_means', model.mean_image);
% train/test data
dataset                     = [];
dataset                     = Dataset.PL_Pizza_trainval_ss(dataset, 'train', conf.use_flipped);
dataset                     = Dataset.PL_Pizza_test_ss(dataset, 'test', false);
